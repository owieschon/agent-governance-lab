...
<!-- sourcebound:allow doc-length reason="The dispatch, observer, verification, recovery, and update cycle is one operator contract" -->
<!-- sourcebound:allow restatement reason="Cron examples intentionally repeat the command wrapper while changing observer and cadence" -->
