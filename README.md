...
| cli-command | 10 | `compare`, `demo`, `doctor`, and 7 more |
| cli-option | 9 | `--check`, `--fetch-source`, `--json`, and 6 more |
...
<!-- clean-docs:inventory-sha256 2207e74d7388b3c9a6f8f6108d59a971ac6fd3094187d6efb4e8806f9f54eafc -->
